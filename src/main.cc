...
"    extend\n"
"    index\n"
"  'index' and 'extend' are a pair of commands often used together. run each\n"
"command above with '-h'\n"
"\n");
	exit(0);
}
void HelpMatch() {
...
"\n"
"  mgrep searches the standard input or text received from an mgrep client\n"
"for concepts defined in the dictionary file.\n"
"\n"
"  If the standard input is in a tab-delimited format, mgrep searches only\n"
"the last column and outputs the matching result along with all preceding\n"
"columns.\n"
"\n"
"  If the standard input does not contain any tab characters, mgrep searches\n"
"the entire line and outputs it as is.\n"
"\n"
...
"\n"
"  'mgrep extend' searches the binary index created by 'mgrep index'\n"
"from a corpus file. It prints strings similar to the concepts defined in\n"
"the dictionary file, along with their occurrence counts. The results can\n"
"then be used to extend the dictionary for subsequent mgrep match operations.\n"
"\n"
"Output columns are\n"
...
"\n"
"  'mgrep index' takes a corpus file as input and builds a binary index,\n"
"which is required by 'mgrep extend'.\n"
"\n"
"Example:\n"
